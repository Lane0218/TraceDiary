...
- 更新时间：`2026-02-08`
- 总任务：`38`
- 状态统计：`DONE=1` / `DOING=1` / `TODO=36` / `BLOCKED=0`
- 当前进行中：`TD-BASE-002`
...
| `TD-BASE-002` | `DOING` | 接入 Tailwind CSS 并配置基础样式 | 工具类生效且构建通过 | `tailwind.config.*` `src/index.css` | — | — |
| `TD-BASE-003` | `TODO` | 建立目录结构（components/pages/hooks/services/types/utils） | 目录与 SPEC 对齐 | `src/` | — | — |
